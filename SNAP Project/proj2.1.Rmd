...
pop %>%
  ...
  ggplot(mapping = aes(long, lat, group = group, fill = X..of.US)) +labs(title="US SNAP Participation per capita by State", subtitle="State SNAP participation rate has small range", caption="Source:USDA Food Nutrition Services")+theme(legend.text = element_text(size = 8),legend.title=element_text(size=6),plot.title=element_text(size=20, 
                                    face="bold", 
                                    family="American Typewriter",
                                    color="black",
                                    hjust=0.5,
